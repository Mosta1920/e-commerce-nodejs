...
function generateHeader(doc) {
  doc
    .image("invoice.png", 50, 45, { width: 50 })
    .fillColor("#444444") // black
    .fontSize(20) // 20
    .text("E-commerce", 110, 57) // E-commerce
    .fillColor("#09c")
    .fontSize(10)
...
function generateInvoiceTable(doc, invoice) {
  ...
  generateTableRow(
    ...
    "Subtotal",
    "",
    formatCurrency(invoice.totalPrice) // orderSubTotal
  );

  
  //shippingCost
  // const shippingCostPostion = subtotalPosition  + 20;
  // generateTableRow(
  //   doc,
  //   shippingCostPostion,
  //   "",
  ...
  //   "Shipping Cost",
  //   "",
  //   formatCurrency(invoice.couponAmount) // orderSubTotal
  // );
  ...
  generateTableRow(
    ...
    "Paid Amount",
    "",
    formatCurrency(invoice.totalPrice) // orderPaidAmount
  );
...
function generateTableRow(
  ...
  doc
    ...
    .text(unitCost, 375, y, { width: 90, align: "right" })
